@extends('nav')
@section('title', 'Add Bill | Senior Life Care Trusts')
@section('wrapper')
@php
...
<div class="">
    <h5 class=" d-flex justify-content-start pt-3 pb-2">
        <b></b>
        <div><a href="{{url('/main')}}" class="text-muted fw-light pointer"><b>Dashboard</b></a> / <b>Add Bill</b></div>
    </h5>
    <div class="row">
                    ...
                    <form id="add_claim" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="number" name="claim_amount" class="form-control" placeholder="$" step="any" value="{{ old('claim_amount') }}" max="10000000" title="Please enter an amount less than or equal to 10 million." />
                                <span class="text-danger">
                                    @error('claim_amount')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="date" name="submission_date" class="form-control mb-3" value="{{ date('Y-m-d') }}" />
                                </div>
                                @else
                                ...
                                <div class="col-lg-6 recurring-bill d-none">
                                    ...
                                    <input type="date" name="expense_date" class="form-control mb-3" min="2021-01-01" max="2030-12-31" />
                                    <span class="text-danger">
                                        @error('expense_date')
                                        {{ $message }}
                                        @enderror
                                ...
                                <div class="col-lg-6 pt-3">
                                    ...
                                    <input class="manual-check-ctrl" name="recurring_bill" type="checkbox" value="{{ 1 }}" id="recurring_bill">
                                </div>
                                <div class="col-lg-6 pt-2 recurring">
                                    ...
                                    <select class="form-control select-2" name="recurring_day">
                                        ...
                                        @for ($i = 1; $i <= 28; $i++) <option value="{{ $i }}">{{ $i }}{{ in_array($i % 100, [11, 12, 13]) ? 'th' : ($i % 10 == 1 ? 'st' : ($i % 10 == 2 ? 'nd' : ($i % 10 == 3 ? 'rd' : 'th'))) }} of every Month</option>
                                            @endfor
                                    </select>
