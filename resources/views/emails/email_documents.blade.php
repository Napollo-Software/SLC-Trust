                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left" valign="top" style="padding: 20px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; letter-spacing: 0.5px; line-height: 24px;">
                            <p style="font-size: 16px; font-weight: 400; margin: 0;">Welcome to the Senior Life Care family! We're thrilled to have you join our Pooled Income Trust. Our dedicated team is here to guide you every step of the way, ensuring a smooth and hassle-free enrollment process.</p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" align="left" valign="top" style="padding: 20px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; letter-spacing: 0.5px; line-height: 24px;">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" valign="top" style="padding: 10px;">
                                                    <a href="{{ $link }}" target="_blank" style="text-decoration: none; display: block; width: 180px; height: 120px; border-radius: 4px; border: 1px solid #cccccc; padding: 10px 15px; font-family: 'Lato', Helvetica, Arial, sans-serif; font-weight: 700; text-align: center;">
                                                        ...
                                                        <p style="color:black; font-size:10px; margin: 0; text-align: center;">{{ $filtered_names[$loop->index] }}</p>
                                                    </a>
                                                </td>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left" valign="top" style="padding: 20px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; letter-spacing: 0.5px; line-height: 24px;">
                            <p style="font-size: 16px; font-weight: 400; margin: 0;">If you have any questions or need assistance, feel free to reach out our support team at {{ config('app.contact') }}.</p>
                        </td>
                    </tr>
                    <tr>
