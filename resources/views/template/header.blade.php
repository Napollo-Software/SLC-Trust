...
<head>
    <script type="text/javascript" id="debugbar_loader" data-time="1686139909"
        src="http://localhost/Noa/index.php?debugbar"></script>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="http://localhost/Noa/assets/images/brand/favicon.ico" />

    <!-- DEBUG-VIEW START 1 APPPATH\Views\layouts\components\styles.php -->

    <!-- BOOTSTRAP CSS -->
    <link id="style" href="http://localhost/Noa/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />

    <!-- STYLE CSS -->
    <link href="http://localhost/Noa/assets/css/style.css" rel="stylesheet" />
    <link href="http://localhost/Noa/assets/css/skin-modes.css" rel="stylesheet" />

    <!--- FONT-ICONS CSS -->
    <link href="http://localhost/Noa/assets/css/icons.css" rel="stylesheet" />
    ...
    <!-- DEBUG-VIEW ENDED 1 APPPATH\Views\layouts\components\styles.php -->
...
<body class="ltr app sidebar-mini light-mode">
    ...
    <div id="global-loader">
        <img src="http://localhost/Noa/assets/images/loader.svg" class="loader-img" alt="Loader">
    </div>
    <!-- /GLOBAL-LOADER -->
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!-- APP-HEADER -->
            <!-- DEBUG-VIEW START 2 APPPATH\Views\layouts\components\app-header.php -->
                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        <a aria-label="Hide Sidebar" class="app-sidebar__toggle" data-bs-toggle="sidebar"
                            href="#"></a>
                        <!-- sidebar-toggle-->
                        <a class="logo-horizontal " href="http://localhost/Noa/index">
                            <img src="http://localhost/Noa/assets/images/brand/logo.png"
                                class="header-brand-img desktop-logo" alt="logo">
                            <img src="http://localhost/Noa/assets/images/brand/logo-3.png"
                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-md-flex main-header-notification flag-dropdown">
                                            <a href="javascript:void(0);"
                                                ...
                                                <img class="header-icons language" alt=""
                                                    src="http://localhost/Noa/assets/images/flags/us_flag.jpg">
                                            </a>
                                        </div>
                                        <!-- SEARCH -->
                                                ...
                                                <div class="px-2 pb-4 pt-2">
                                                    <div class="row mb-2">
                                                        <div class="col d-flex">
                                                            <a href="http://localhost/Noa/maps1"
                                                        ...
                                                        <div class="col d-flex p-0">
                                                            <a href="http://localhost/Noa/calendar2"
                                                                class="dropdown-menu-item text-muted source-logo-container">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="source-logo"
                                                                    enable-background="new 0 0 24 24"
                                                        ...
                                                        <div class="col d-flex">
                                                            <a href="http://localhost/Noa/mail-inbox"
                                                                class="dropdown-menu-item text-muted source-logo-container">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="source-logo"
                                                                    enable-background="new 0 0 24 24"
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col d-flex">
                                                            <a href="http://localhost/Noa/chat"
                                                                class="dropdown-menu-item text-muted source-logo-container">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="source-logo"
                                                                    enable-background="new 0 0 24 24"
                                                        ...
                                                        <div class="col d-flex p-0">
                                                            <a href="http://localhost/Noa/file-manager"
                                                                class="dropdown-menu-item text-muted source-logo-container">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="source-logo"
                                                                    enable-background="new 0 0 24 24"
                                                        ...
                                                        <div class="col d-flex">
                                                            <a href="http://localhost/Noa/products"
                                                                class="dropdown-menu-item text-muted source-logo-container">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="source-logo"
                                                                    enable-background="new 0 0 24 24"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col d-flex p-0">
                                                            <a href="http://localhost/Noa/blog"
                                                                class="dropdown-menu-item text-muted source-logo-container">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="source-logo"
                                                                    enable-background="new 0 0 24 24"
                                                        ...
                                                        <div class="col d-flex">
                                                            <a href="http://localhost/Noa/form-elements"
                                                                class="dropdown-menu-item text-muted source-logo-container">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="source-logo"
                                                                    enable-background="new 0 0 24 24"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <div class="header-dropdown-list cart-menu ps4 overflow-hidden">
                                                    <a class="dropdown-item d-flex p-4"
                                                        href="http://localhost/Noa/cart">
                                                        <span
                                                            class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="http://localhost/Noa/assets/images/ecommerce/1.jpg"></span>
                                                    ...
                                                    <a class="dropdown-item d-flex p-4"
                                                        ...
                                                        <span
                                                            class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="http://localhost/Noa/assets/images/ecommerce/2.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
                                                    ...
                                                    <a class="dropdown-item d-flex p-4"
                                                        ...
                                                        <span
                                                            class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="http://localhost/Noa/assets/images/ecommerce/3.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
                                                    ...
                                                    <a class="dropdown-item d-flex p-4"
                                                        ...
                                                        <span
                                                            class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="http://localhost/Noa/assets/images/ecommerce/4.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
                                                    ...
                                                    <a class="dropdown-item d-flex p-4"
                                                        ...
                                                        <span
                                                            class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="http://localhost/Noa/assets/images/ecommerce/5.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
                                        ...
                                        <div class="dropdown d-md-flex message">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow"
                                                ...
                                                <div class="message-menu ps2 overflow-hidden">
                                                    <a class="dropdown-item d-flex" href="http://localhost/Noa/chat">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="http://localhost/Noa/assets/images/users/1.jpg"
                                                            style="background: url(&quot;http://localhost/Noa/assets/images/users/1.jpg&quot;) center center;"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="http://localhost/Noa/chat">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="http://localhost/Noa/assets/images/users/15.jpg"
                                                            style="background: url(&quot;http://localhost/Noa/assets/images/users/15.jpg&quot;) center center;">
                                                        </span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="http://localhost/Noa/chat">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="http://localhost/Noa/assets/images/users/12.jpg"
                                                            style="background: url(&quot;http://localhost/Noa/assets/images/users/12.jpg&quot;) center center;">
                                                        </span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="http://localhost/Noa/chat">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="http://localhost/Noa/assets/images/users/4.jpg"
                                                            style="background: url(&quot;http://localhost/Noa/assets/images/users/4.jpg&quot;) center center;">
                                                        </span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                        ...
                                        <div class="dropdown d-md-flex notifications">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <div class="notifications-menu ps3 overflow-hidden">
                                                    <a class="dropdown-item" href="http://localhost/Noa/chat">
                                                    ...
                                                    <a class="dropdown-item" href="http://localhost/Noa/mail-inbox">
                                                        <div class="notification-each d-flex">
                                                    ...
                                                    <a class="dropdown-item" href="http://localhost/Noa/cart">
                                                        <div class="notification-each d-flex">
                                                    ...
                                                    <a class="dropdown-item" href="http://localhost/Noa/blog-details">
                                                        <div class="notification-each d-flex">
                                        ...
                                        <div class="dropdown d-md-flex profile-1">
                                            <a href="#" data-bs-toggle="dropdown"
                                                ...
                                                <span>
                                                    <img src="http://localhost/Noa/assets/images/faces/6.jpg"
                                                        alt="profile-user"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <a class="dropdown-item" href="http://localhost/Noa/profile">
                                                ...
                                                <a class="dropdown-item" href="http://localhost/Noa/pricing">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                                        enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                        <path
                                                ...
                                                <a class="dropdown-item" href="http://localhost/Noa/settings">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                                        enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                        <path
                                                ...
                                                <a class="dropdown-item" href="http://localhost/Noa/lockscreen">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                                        enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                        <path
                                                ...
                                                <a class="dropdown-item" href="http://localhost/Noa/login">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                                        enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                        <path
            ...
            <!-- DEBUG-VIEW ENDED 2 APPPATH\Views\layouts\components\app-header.php -->
            <!-- /APP-HEADER -->

            <!-- APP-SIDEBAR -->
            <!-- DEBUG-VIEW START 3 APPPATH\Views\layouts\components\app-sidebar.php -->
            <div class="sticky">
                <div class="app-sidebar__overlay" data-bs-toggle="sidebar"></div>
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="http://localhost/Noa/index">
                            <img src="http://localhost/Noa/assets/images/brand/logo.png"
                                class="header-brand-img desktop-logo" alt="logo">
                            <img src="http://localhost/Noa/assets/images/brand/logo-1.png"
                                class="header-brand-img toggle-logo" alt="logo">
                            <img src="http://localhost/Noa/assets/images/brand/logo-2.png"
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="http://localhost/Noa/form-elements" class="slide-item">Form
                                            Elements</a></li>
                                    <li><a href="http://localhost/Noa/form-layouts" class="slide-item">Form
                                            Layouts</a></li>
                                    <li><a href="http://localhost/Noa/form-validation" class="slide-item">Form
                                            Validation</a></li>
                                    <li><a href="http://localhost/Noa/form-advanced" class="slide-item">Form
                                            Advanced</a></li>
                                    <li><a href="http://localhost/Noa/wysiwyag" class="slide-item">Form Editors</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/form-editable" class="slide-item">Form
                                            Editable</a></li>
                                    <li><a href="http://localhost/Noa/form-wizard" class="slide-item">Form Wizard</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="http://localhost/Noa/tables" class="slide-item">Default Table</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/datatable" class="slide-item">Data Tables</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/table-editable" class="slide-item">Editable
                                            Tables</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide"
                                    href="http://localhost/Noa/landing" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"
                                        enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                        <path
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="http://localhost/Noa/chart-echart" class="slide-item"> ECharts</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/chart-chartjs" class="slide-item">Chart Js</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/chart-flot" class="slide-item"> Flot Charts</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/chart-morris" class="slide-item"> Morris
                                            Charts</a></li>
                                    <li><a href="http://localhost/Noa/chart-nvd3" class="slide-item">Nvd3 Charts</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="http://localhost/Noa/icons" class="slide-item">Font Awesome</a></li>
                                    <li><a href="http://localhost/Noa/icons2" class="slide-item"> Material Design
                                            Icons</a></li>
                                    <li><a href="http://localhost/Noa/icons3" class="slide-item"> Simple Line
                                            Icons</a></li>
                                    <li><a href="http://localhost/Noa/icons4" class="slide-item"> Feather Icons</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/icons5" class="slide-item"> Ionic Icons</a></li>
                                    <li><a href="http://localhost/Noa/icons6" class="slide-item"> Flag Icons</a></li>
                                    <li><a href="http://localhost/Noa/icons7" class="slide-item"> pe7 Icons</a></li>
                                    <li><a href="http://localhost/Noa/icons8" class="slide-item"> Themify Icons</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/icons9" class="slide-item">Typicons Icons</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/icons10" class="slide-item">Weather Icons</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="http://localhost/Noa/maps1" class="slide-item">Leaflet Maps</a></li>
                                    <li><a href="http://localhost/Noa/maps2" class="slide-item">Mapel Maps</a></li>
                                    <li><a href="http://localhost/Noa/maps" class="slide-item">Vector Maps</a></li>
                                </ul>
                            </li>
                            <li>
                                <h3>Submenu's</h3>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="http://localhost/Noa/calendar2" class="slide-item">Calendar</a></li>
                                    <li><a href="http://localhost/Noa/chat" class="slide-item">Chat</a></li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                            href="#"><span class="sub-side-menu__label">E-Commerce</span><i
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="http://localhost/Noa/cart">Cart</a>
                                            </li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/checkout">Checkout</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/products">Products</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/product-details">Product-Details</a>
                                            </li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/wishlist">Wishlist</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/file-manager">Files</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/file-manager-1">File Manager</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/file-manager-2">File Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/mail-inbox">Inbox</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/mail-compose">Compose Mail</a></li>
                                            <li><a class="sub-slide-item" href="http://localhost/Noa/mail-read">Read
                                                    Mail</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/mail-settings">Mail Settings</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/invoice-list">Invoice List</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/invoice-details">Invoice Details</a>
                                            </li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/invoice-create">Create Invoice</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/invoice-timelog">Time Log Invoice</a>
                                            </li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/invoice-edit">Edit Invoice</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/projects">Projects</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/projects-list">Projects List</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/project-details">Project Details</a>
                                            </li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/project-new">Project New</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/project-edit">Edit Project</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="http://localhost/Noa/ticket-details" class="slide-item"><span
                                    ...
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                            href="#"><span class="sub-side-menu__label">Tasks</span><i
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="http://localhost/Noa/tasks-list">Task
                                                    List</a></li>
                                            <li><a class="sub-slide-item" href="http://localhost/Noa/task-edit">Edit
                                                    Task</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/task-create">Create Task</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/clients">Clients</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/client-create">Add Client</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="http://localhost/Noa/alerts" class="slide-item">Alerts</a></li>
                                    <li><a href="http://localhost/Noa/avatar" class="slide-item">Avatar</a></li>
                                    <li><a href="http://localhost/Noa/badge" class="slide-item">Badges</a></li>
                                    <li><a href="http://localhost/Noa/breadcrumbs" class="slide-item">Breadcrumbs</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/buttons" class="slide-item">Buttons</a></li>
                                    <li><a href="http://localhost/Noa/colors" class="slide-item">Colors</a></li>
                                    <li><a href="http://localhost/Noa/dropdown" class="slide-item">Dropdown</a></li>
                                    <li><a href="http://localhost/Noa/gallery" class="slide-item">Gallery</a></li>
                                    <li><a href="http://localhost/Noa/loaders" class="slide-item">Loaders</a></li>
                                    <li><a href="http://localhost/Noa/navigation" class="slide-item">Navigation</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/notify" class="slide-item">Notifications</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/offcanvas" class="slide-item">Offcanvas</a></li>
                                    <li><a href="http://localhost/Noa/pagination" class="slide-item">Pagination</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/panels" class="slide-item">Panels</a></li>
                                    <li><a href="http://localhost/Noa/rangeslider" class="slide-item">Range Slider</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/scroll" class="slide-item">Scroll</a></li>
                                    <li><a href="http://localhost/Noa/tags" class="slide-item">Tags</a></li>
                                    <li><a href="http://localhost/Noa/thumbnails" class="slide-item">Thumbnails</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/treeview" class="slide-item">Treeview</a></li>
                                    <li><a href="http://localhost/Noa/typography" class="slide-item">Typography</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="http://localhost/Noa/accordion" class="slide-item">Accordions</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/carousel" class="slide-item">Carousel</a></li>
                                    <li><a href="http://localhost/Noa/cards" class="slide-item">Cards</a></li>
                                    <li><a href="http://localhost/Noa/counters" class="slide-item">Counters</a></li>
                                    <li><a href="http://localhost/Noa/modal" class="slide-item">Modals</a></li>
                                    <li><a href="http://localhost/Noa/timeline" class="slide-item">Timeline</a></li>
                                    <li><a href="http://localhost/Noa/sweetalert" class="slide-item">Sweet-Alerts</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/rating" class="slide-item">Rating</a></li>
                                    <li><a href="http://localhost/Noa/mediaobject" class="slide-item">Media Object</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/tabs" class="slide-item">Tabs</a></li>
                                    <li><a href="http://localhost/Noa/tooltipandpopover" class="slide-item">Tooltip
                                            and Popover</a></li>
                                    <li><a href="http://localhost/Noa/progress" class="slide-item">Progress Bars</a>
                                    </li>

                                    <li><a href="http://localhost/Noa/footers" class="slide-item">Footers</a></li>
                                    <li><a href="http://localhost/Noa/users-list" class="slide-item">Users List</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/file-attachments" class="slide-item">File
                                            Attachments</a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                            href="#"><span class="sub-side-menu__label">Authentication</span><i
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="http://localhost/Noa/login">Sign
                                                    In</a></li>
                                            <li><a class="sub-slide-item" href="http://localhost/Noa/register">Sign
                                                    Up</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/forgot-password">Forgot Password</a>
                                            </li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/lockscreen">Lockscreen</a></li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/construction">UnderConstruction</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                            href="#"><span class="sub-side-menu__label">Error Pages</span><i
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="http://localhost/Noa/error404">404
                                                    Error</a></li>
                                            <li><a class="sub-slide-item" href="http://localhost/Noa/error500">500
                                                    Error</a></li>
                                            <li><a class="sub-slide-item" href="http://localhost/Noa/error501">501
                                                    Error</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="http://localhost/Noa/settings" class="slide-item">Settings</a></li>
                                    <li><a href="http://localhost/Noa/profile" class="slide-item">Profile</a></li>
                                    <li><a href="http://localhost/Noa/about" class="slide-item">About Company</a></li>
                                    <li><a href="http://localhost/Noa/services" class="slide-item">Services</a></li>
                                    <li><a href="http://localhost/Noa/switcher" class="slide-item">Switcher</a></li>
                                    <li><a href="http://localhost/Noa/terms" class="slide-item">Terms</a></li>
                                    <li><a href="http://localhost/Noa/faq" class="slide-item">Faq's</a></li>
                                    <li><a href="http://localhost/Noa/pricing" class="slide-item">Pricing</a></li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                            href="#"><span class="sub-side-menu__label">Blog</span><i
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="http://localhost/Noa/blog">Blog</a>
                                            </li>
                                            <li><a class="sub-slide-item"
                                                    href="http://localhost/Noa/blog-details">Blog Details</a></li>
                                            <li><a class="sub-slide-item" href="http://localhost/Noa/blog-edit">Edit
                                                    Post</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="http://localhost/Noa/background" class="slide-item">Background</a>
                                    </li>
                                    <li><a href="http://localhost/Noa/border" class="slide-item">Border</a></li>
                                    <li><a href="http://localhost/Noa/display" class="slide-item">Display</a></li>
                                    <li><a href="http://localhost/Noa/flex" class="slide-item">Flex</a></li>
                                    <li><a href="http://localhost/Noa/height" class="slide-item">Height</a></li>
                                    <li><a href="http://localhost/Noa/margin" class="slide-item">Margin</a></li>
                                    <li><a href="http://localhost/Noa/padding" class="slide-item">Padding</a></li>
                                    <li><a href="http://localhost/Noa/position" class="slide-item">Position</a></li>
                                    <li><a href="http://localhost/Noa/width" class="slide-item">Width</a></li>
                                    <li><a href="http://localhost/Noa/opacity" class="slide-item">Opacity</a></li>
                                    <li><a href="http://localhost/Noa/empty" class="slide-item">Empty Page</a></li>
                                </ul>
                            </li>
                        </ul>
            ...
            <!-- DEBUG-VIEW ENDED 3 APPPATH\Views\layouts\components\app-sidebar.php -->
            <!-- /APP-SIDEBAR -->
        ...
        <!-- DEBUG-VIEW START 4 APPPATH\Views\layouts\components\modal.php -->
                        ...
                        <ul class="row row-sm p-3">
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block active">
                                    <span class="country-selector"><img alt="unitedstates" src="http://localhost/Noa/assets/images/flags/us_flag.jpg" class="me-2 language"></span>United States
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="italy" src="http://localhost/Noa/assets/images/flags/italy_flag.jpg" class="me-2 language"></span>Italy
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="spain" src="http://localhost/Noa/assets/images/flags/spain_flag.jpg" class="me-2 language"></span>Spain
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="india" src="http://localhost/Noa/assets/images/flags/india_flag.jpg" class="me-2 language"></span>India
                            </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="french" src="http://localhost/Noa/assets/images/flags/french_flag.jpg" class="me-2 language"></span>French
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="russia" src="http://localhost/Noa/assets/images/flags/russia_flag.jpg" class="me-2 language"></span>Russia
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="germany" src="http://localhost/Noa/assets/images/flags/germany_flag.jpg" class="me-2 language"></span>Germany
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="argentina" src="http://localhost/Noa/assets/images/flags/argentina_flag.jpg" class="me-2 language"></span>Argentina
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="uae" src="http://localhost/Noa/assets/images/flags/uae_flag.jpg" class="me-2 language"></span>UAE
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="austria" src="http://localhost/Noa/assets/images/flags/austria_flag.jpg" class="me-2 language"></span>Austria
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="mexico" src="http://localhost/Noa/assets/images/flags/mexico_flag.jpg" class="me-2 language"></span>Mexico
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="china" src="http://localhost/Noa/assets/images/flags/china_flag.jpg" class="me-2 language"></span>China
                            </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="poland" src="http://localhost/Noa/assets/images/flags/poland_flag.jpg" class="me-2 language"></span>Poland
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="canada" src="http://localhost/Noa/assets/images/flags/canada_flag.jpg" class="me-2 language"></span>Canada
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="malaysia" src="http://localhost/Noa/assets/images/flags/malaysia_flag.jpg" class="me-2 language"></span>Malaysia
                                </a>
                            </li>
                        </ul>
                    </div>
...
<!-- DEBUG-VIEW ENDED 4 APPPATH\Views\layouts\components\modal.php -->
        <!-- /COUNTRY-SELECTOR MODAL-->

        <!-- FOOTER -->
        <!-- DEBUG-VIEW START 5 APPPATH\Views\layouts\components\footer.php -->
        <footer class="footer">
            <div class="container">
...
<!-- DEBUG-VIEW ENDED 5 APPPATH\Views\layouts\components\footer.php -->
    ...
    <!-- JQUERY JS -->
    <script src="http://localhost/Noa/assets/js/jquery.min.js"></script>

    <!-- BOOTSTRAP JS -->
    <script src="http://localhost/Noa/assets/plugins/bootstrap/js/popper.min.js"></script>
    <script src="http://localhost/Noa/assets/plugins/bootstrap/js/bootstrap.min.js"></script>

    <!-- SIDE-MENU JS -->
    <script src="http://localhost/Noa/assets/plugins/sidemenu/sidemenu.js"></script>

    <!-- PERFECT SCROLLBAR JS-->
    <script src="http://localhost/Noa/assets/plugins/p-scroll/perfect-scrollbar.js"></script>
    <script src="http://localhost/Noa/assets/plugins/p-scroll/pscroll.js"></script>
    ...
    <script src="http://localhost/Noa/assets/plugins/datatable/dataTables.responsive.min.js"></script>
...
<!-- DEBUG-VIEW ENDED 6 APPPATH\Views\layouts\components\scripts.php -->
    <!-- SCRIPTS CLOSED -->

</body>
</html>

<!-- DEBUG-VIEW ENDED 7 APPPATH\Views\layouts\main.php -->

<!-- DEBUG-VIEW ENDED 8 APPPATH\Views\pages\index.php -->
