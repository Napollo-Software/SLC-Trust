                        ...
                        <div>
                            <div class="beneficiary-information-name-form">
                                <div class="name-form-container">
                                    <div class="name-form">
                                        <input type="text" name="sponsor_first_name" value=" " id="first" class="inp-first"  > <br>
                                        <span>Name</span>
                                    </div> 
                                </div>
                                <div class="name-form-container">
                                    <div class="name-form">
                                        <input type="text" name=" " value=" " id="first" class="inp-first"  > <br>
                                        <span>Date</span>
                                    </div> 
                                </div>
                                <div class="name-form-container">
                                    <div class="name-form">
                                    <input type="text" name="joinder_signature_2" id="signature_input_2" class="inp-first" oninput="generateSignature(2)"  > <br>
                                    <span>Signature</span>
                                    </div> 
                                </div>
                                <div class="name-form-container">
