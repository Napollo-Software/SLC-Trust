...
<body>
    <div class='container'>
        <form id="disability-form" method="POST" action="{{ route('save.disability') }}">
             ...
             <div class='form-row gap-15'>
                ...
                <div class='form-cell'>
                    ...
                    <div class='form-cell p-10 mt-14' style='background-color:rgba(0,0,0,0.2)'>
                        ...
                        <div class='row gap-5 text-base align-items-center checkbox-group gap-20'>
            ...
            <div class='form-row gap-5 text-base align-items-center checkbox-group gap-20'>
                ...
                <div class='form-row gap-15 text-base'>
                    ...
                    <div class='form-cell gap-5'>
                        <div class='row p-0 align-items-end gap-5'>
                ...
                <div class='form-row gap-5 text-base align-items-center'>
                    <div class='form-cell'>
                        <div class='row p-0 gap-5 text-base align-items-center checkbox-group gap-20'>
                ...
                <table class='mt-5'>
                    ...
                    <tr>
                        ...
                        <div class='flex-col gap-5'>
                            <div class='form-row p-0 gap-5 text-base align-items-center checkbox-group gap-20'>
                ...
                <table class='mt-5'>
                    ...
                    <tr>
                        <td>
                        <div class='form-row gap-5 text-base align-items-center checkbox-group gap-20 p-0'>
                ...
                <div class='form-row mt-5' style='border:2px solid;padding-top:2px'>
                    <div class='flex-col w-full p-0'>
                        ...
                        <div class='form-row gap-5 text-base px-10' style='padding:0.3rem 0.6rem checkbox-group gap-20'>
                ...
                <table class='mt-5'>
                    ...
                    <tr>
                        ...
                        <td data-label='Type of business'>
                            <div class='form-row gap-5 align-items-end'>
                                <span class='nowrap font-bold'>Rate of Pay:</span>
                    ...
                    <tr>
                        <td colspan='3'>
                            <div class='form-row gap-15 p-0'>
                                ...
                                <div class='form-row gap-15 align-items-end p-0 flex-1'>
                                    <span>pounds</span>
                ...
                <table class='mt-5'>
                    ...
                    <tr>
                        <td colspan='3'>
                            <div class='form-row gap-15 p-0'>
                                <span class='form-row p-0'> During a typical day, how many hours did you:</span>
                                <div class='form-row p-0 gap-5 align-items-end' style='width:20%'>
                                    <span>Stand</span>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".chb").change(function() {
            const group = $(this).closest('.checkbox-group gap-20');    
