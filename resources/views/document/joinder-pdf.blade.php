...
<head>
    ...
    <style>
        ...
        div {
            line-height: 0.8 !important;
            /* Apply globally to these elements */
        }
    ...
    <form id="joinderForm" method="POST" action="{{ route('save.joinder') }}">
                ...
                <div style="position: absolute; bottom: 300px; text-align: center; left: 0; right: 0;">
                    <div style="text-align: center;margin-top:50px">
                        <div style="width: fit-content;">
                            <div class="black"
                                style="color: rgb(52 159 153); padding: 5px 10px; font-size: 2.8rem;margin-left:17px;">
                                JOINDER</div>
                        </div>
                    </div>
                ...
                <div style="position: absolute; bottom: 40px; text-align: center; left: 0; right: 0;">
                    <div
                        ...
                        <div style="display: table-row;">
                            ...
                            <div style="display: table-cell; text-align: left;" class="xl">
                                718.500.3235</div>
                        </div>
                    </div>
                    <div
                        style="width: 100%; text-align: center; white-space: nowrap; display: table; border-collapse: collapse;margin-bottom:7px">
                        <div style="display: table-row;">
                            <div style="display: table-cell;width:45%;text-align: right;">
                                <div style="padding-right: 5px" class="xl">Fax:</div>
                            </div>
                            <div class="xl" style="display: table-cell; text-align: left;">
                                718.500.3225</div>
                        </div>
                    </div>
                    ...
                    <div
                        style="width: 100%; text-align: center; white-space: nowrap; display: table; border-collapse: collapse;margin-top:7px">
                        <div style="display: table-row;">
        ...
        <div class="page-1">
            <div class="center-text"
                style="background-color: rgb(184 221 219);padding-top: 7px;padding-bottom: 7px;padding-left:10px;padding-right:10px;">
                <p style="text-align:center;" class="strong lg">SLC SUPPLEMENTAL NEEDS TRUST</p>
                <p style="text-align:center;color:rgb(52 159 153);margin-top:-11px" class="lg">Joinder Agreement /
                    Beneficiary
                    Profile Sheet</p>
            </div>
            <div class="xs">
                ...
                <p class="" style="margin">NOTE: All questions must be answered or your application will be
                    delayed.</p>
            </div class="md">
            <p class="md section-heading" style="background-color:rgb(184 221 219);color:rgb(52 159 153);;width:29%">
            ...
            <div style="display: table-row;">
                <p style="display:table-cell;margin-top:10px;padding-top:10px" class="sm strong"> Marital Status
                    <label style="font-family:Poppins-Regular" class="xs">
                        <input type="checkbox" name="sponsor_marital_status1" style="margin-top:-7px;padding-top:-7px"
                            value="Married"
                            {{ isset($sponsor_marital_status1) && $sponsor_marital_status1 === 'Married' ? 'checked' : '' }}>
                        <label>Married</label>
                    </label>
                    <label style="font-family:Poppins-Regular" class="xs">
                        <input type="checkbox" name="sponsor_marital_status1"
                            style="margin-top:-7px;padding-top:-7px" value="Widowed"
                            {{ isset($sponsor_marital_status1) && $sponsor_marital_status1 === 'Widowed' ? 'checked' : '' }}>
                        <label>Widowed</label>
                    </label>
                    <label style="font-family:Poppins-Regular" class="xs">
                        <input type="checkbox" name="sponsor_marital_status" style="margin-top:-7px;padding-top:-7px"
                            value="Single"
        ...
        <div style="display: table; width: 100%; margin-bottom: 8px;margin-top:10px">
            <div style="display: table-row;">
                ...
                <div style="display: table-cell;width: 33.33%;" class="xs">
                    <input type="text" name="sponsor_citizenship" value="{{ $sponsor_citizen }}"
                        style="width: 100%;">
        ...
        <div style="display: table; width:100%">
            ...
            <div style="display: table-row;" class="xs">
                ...
                <div style="display: table-cell;width:50%;padding-right:20px">
                    <input type="text" value="{{ $sponsor_tel_home }}" name="sponsor_tel_home"
                        style="width: 100%">
        ...
        <div style="display: table; width:45%" class="xs">
            <div style="display: table-row;">
                <div style="display: table-cell;">
                    <input type="text" value="{{ $beneficiary_email }}" name="beneficiary_email"
                        style="width:100%">
        ...
        <div class="page-2" style="margin-top:-5px">
            ...
            <p class="xs" style=" ">Who will be your primary contact?
                <label style="margin: 0;">
                    <input type="checkbox" style="margin-top:-7px;padding-top:-7px" name="auth_beneficiary"
                        value="Beneficiary"
                ...
                <label style="margin: 0;">
                    <input type="checkbox" name="auth_beneficiary" style="margin-top:-7px;padding-top:-7px"
                        value="Auth. Rep.1"
            ...
            <div class="border-container">
                <p style="padding:0;margin: 0;" class="xs">
                    The following individual will be authorized to communicate with Trusted Pooled Trust. I authorize
                    this
                    individual
                ...
                <div class="xs" style="display: table;width:100%;">
                    <div style="display: table-row;">
                        <div style="display: table-cell;">
                            ...
                            <input type="text" value="{{ $auth_rep_one_fname }}" name="auth_rep_one_fname"
                                style="width: 95%" /> <br>
                            <label class="italic">First</label>
                        </div>
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_one_lname }}"name="auth_rep_one_lname"
                                style="width: 95%" /> <br>
                            <label class="italic">Last</label>
                        </div>
                    </div>
                ...
                <div style="display: table;width:100%;margin-top:10px">
                    ...
                    <div style="display: table-row;" class="xs">
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_one_tel }}" name="auth_rep_one_tel"
                                style="width: 95%"> <br>
                            <label class="italic">Home Phone</label>
                        </div>
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_one_cell }} " name="auth_rep_one_cell"
                                style="width: 95%"> <br>
                            <label class="italic">Cell Phone</label>
                        </div>
                ...
                <div style="display: table;width:100%;margin-top:10px" class="xs">
                    <div style="display: table-row;">
                        <div style="display: table-cell;">
                            <input type="text" value="{{ $auth_rep_one_email }}" name="auth_rep_one_email"
                                style="width: 95%" /> <br>
                            <label class="italic">Email</label>
                        </div>
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_one_relation_beneficiary }}"
                                name="auth_rep_one_relation_beneficiary" style="width: 95%" /> <br>
                ...
                <div style="display: table;width:100%;margin-top:10px">
                    ...
                    <div style="display: table-row;" class="xs">
                        <div style="display: table-cell;">
                            <input type="text" value="{{ $auth_rep_one_address }}" name="auth_rep_one_address"
                                style="width: 95%">
                            <label class="italic">Address</label>
                        </div>
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_one_apt }}" name="auth_rep_one_apt"
                                style="width: 95%">
                            <label class="italic">Apt #</label>
                        </div>
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_one_city }}" name="auth_rep_one_city"
                                style="width: 95%" />
                            <label class="italic">City</label>
                        </div>
                        <div style="display: table-cell;">

                            <input type="text" value="{{ $auth_rep_one_state }}" name="auth_rep_one_state"
                                style="width: 95%" />
                            <label class="italic">State</label>
                        </div>

                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_one_zip }}"name="auth_rep_one_zip"
                                style="width: 95%" />
                            <label class="italic">Zip</label>
                        </div>
                    </div>
            ...
            <div class="border-container" style="margin-top: 5px;">
                ...
                <div style="display: table;width:100%;margin-top:10px" class="xs">
                    <div style="display: table-row;">
                        <div style="display: table-cell;">
                            ...
                            <input type="text" value="{{ $auth_rep_two_fname }}" name="auth_rep_two_fname"
                                style="width: 95%" /> <br>
                            <label class="italic">First</label>
                        </div>
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_two_lname }}"name="auth_rep_two_lname"
                                style="width: 95%" /> <br>
                            <label class="italic">Last</label>
                        </div>
                    </div>
                ...
                <div style="display: table;width:100%;margin-top:10px">
                    ...
                    <div style="display: table-row;" class="xs">
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_two_tel }}" name="auth_rep_two_tel"
                                style="width: 95%"> <br>
                            <label class="italic">Home Phone</label>
                        </div>
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_two_cell }} " name="auth_rep_two_cell"
                                style="width: 95%">
                            <label class="italic">Cell Phone</label>
                        </div>
                        <p style="margin-left:10px;margin-top:0px">Preferred Phone
                            <label style="margin: 0;">
                                <input type="checkbox" name="authorized_preferred_cell2" class="checkboxissue"
                                    value="Cell"
                ...
                <div style="display: table;width:100%;margin-top:10px;padding-top:10px" class="xs">
                    <div style="display: table-row;">
                        <div style="display: table-cell;">
                            <input type="text" value="{{ $auth_rep_two_email }}" name="auth_rep_two_email"
                                style="width: 95%" /> <br>
                            <label class="italic">Email</label>
                        </div>
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_two_relation_beneficiary }}"
                                name="auth_rep_two_relation_beneficiary" style="width: 95%" /> <br>
                            <label class="italic">Relationship to Beneficiary
                            </label>
                        </div>
                    </div>
                ...
                <div style="display: table;width:100%">
                    ...
                    <div class="xs" style="display: table-row;">
                        <div style="display: table-cell;">
                            <input type="text" value="{{ $auth_rep_two_address }}" name="auth_rep_two_address"
                                style="width: 95%">
                            <label class="italic">Address</label>
                        </div>
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_two_apt }}" name="auth_rep_two_apt"
                                style="width: 95%">
                            <label class="italic">Apt #</label>
                        </div>
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_two_city }}" name="auth_rep_two_city"
                                style="width: 95%" />
                            <label class="italic">City</label>
                        </div>
                        <div style="display: table-cell;">

                            <input type="text" value="{{ $auth_rep_two_state }}" name="auth_rep_two_state"
                                style="width: 95%" />
                            <label class="italic">State</label>
                        </div>
                        <div style="display: table-cell">
                            <input type="text" value="{{ $auth_rep_two_zip }}"name="auth_rep_two_zip"
                                style="width: 95%" />
                            <label class="italic">Zip</label>
                        </div>
                    </div>
        ...
        <p class="md section-heading" style="background-color:rgb(184 221 219);color:rgb(52 159 153);; width:21%">
            REFERRING SOURCE
        </p>
        <p class="xs"> The following individual will be authorized to communicate with Trusted Pooled Trust. I
            authorize this
            individual
        ...
        <div style="display: table; width:100%" class="xs">
            <div style="display: table-row;width:100%">
                <div style="display: table-cell; width: 50%;">
                    <input type="text" value="{{ $referring_agency }}" name="referring_agency"
                        style="width:95%" /> <br>
                    <label class="italic">Name of Agency</label>
                </div>
                <div style="display: table-cell; width: 50%;">
                    <input type="text" value="{{ $referring_contract }}" name="referring_contract"
                        style="width:95%" /> <br>
            ...
            <div style="display: table-row;">
                <div style="display: table-cell;margin-top:6px;padding-top:7px">
                    ...
                    <input type="text" value="{{ $referring_tel }}" name="referring_tel" style="width:95%" />
                    <br>
                    <label class="italic">Home</label>
                </div>

                <div style="display: table-cell;margin-top:6px;padding-top:7px">
                    <input type="text" value="{{ $referring_email }}"name="referring_email" style="width:95%" />
                    <br>
                    <label class="italic">Email</label>
                </div>
            </div>
        ...
        <div style="display:table;width:100%" class="xs">
            <div style="display: table-row;">
                <div style="display: table-cell;margin-top:6px;padding-top:7px">
                    <input type="text" value="{{ $referring_address }}" name="referring_address"
                        style="width:95%">
                    <label class="italic">Address</label>
                </div>
                <div style="display: table-cell;margin-top:6px;padding-top:7px">
                ...
                <div style="display: table-cell;margin-top:6px;padding-top:7px">
                    <input type="text" value="{{ $referring_state }}" name="referring_state"
                        style="width:95%" />
                    <label class="italic">State</label>
                </div>
                <div style="display: table-cell;margin-top:6px;padding-top:7px">
        ...
        <div class="page-3">
            ...
            <div style="margin: 0; padding-bottom:6px;padding-top:6px" class='xs'>
                <input type="checkbox" name="account_establishing_reason1" class="checkboxissue"
                    value="Shelter Monthly Excess Income"
                ...
                <input type="checkbox" name="account_establishing_reason1" class="checkboxissue"
                    value="Shelter Excess Resources"
                ...
                <table style="padding-top: 0px; margin-top:10px;">
                    <thead>
                        <tr style="padding: 0; margin: 0;">
                            <td class='xs' style='width:190px;padding:6px;text-align:left;padding-left:12px'>
                                Please Attach MAP / LDSS Notice of Decision</td>
                            <td class='xs'
                                style="vertical-align: bottom;padding:6px;text-align:left;padding-left:12px">Applicant
                            </td>
                            <td class='xs'
                                style="vertical-align: bottom;padding:6px;text-align:left;padding-left:12px">Spouse
                            </td>
                        </tr>
                    </thead>
                    <tr style="padding: 0; margin: 0;" class='xs'>
                        <td style="width:180px;margin:0;padding:0px;">
                            <p
                                style="margin:0;padding:3px;text-align:left;padding-left:12px;padding-top:4px;line-height :12px !important;">
                                <span>
                                    Application Status
                                </span>
                                <br>
                        ...
                        <td class='xs' style="width:80px;margin:0;">
                            <div style="margin:0;padding:4px;text-align:left;padding-left:12px;padding-top:8px">
                                <input type="checkbox" name="beneficiary_receive_medicaid_spouse1"
                                    class="checkboxissue" value="Yes"
                                ...
                                <input type="checkbox" name="beneficiary_receive_medicaid_spouse3"
                                    class="checkboxissue" value="Pending"
                    ...
                    <tr style="padding: 0; margin: 0;" class='xs'>
                        <td style="width:80px;padding:4px;text-align:left;padding-left:12px">
                            CIN Number/medicaid Number
                        </td>
                        <td style="width:80px;vertical-align: bottom;padding:4px;text-align:left;padding-left:12px">
                            <input type="text" value="{{ $applicant_medicaid_cin_number }}" style='border:none'
                                class="no-border" name="applicant_medicaid_cin_number">
                        </td>
                        <td style="width:80px;vertical-align: bottom;padding:4px;text-align:left;padding-left:12px">
                            <input type="text" value="{{ $spouse_medicaid_cin_number }}" style='border:none'
                                class="no-border" name="spouse_medicaid_cin_number">
                        </td>
                    </tr>
                    <tr style="padding: 0; margin: 0;" class='xs'>
                        <td style="width:80px; padding:4px;text-align:left;padding-left:12px">
                        ...
                        <td style="width:80px;vertical-align: bottom;padding:4px;text-align:left;padding-left:12px">
                            <input type="text" value="{{ $medicaid_applicant_monthly_spend_down }}"
                                style='border:none' class="no-border" name="medicaid_applicant_monthly_spend_down">
                        </td>
                        <td style="width:80px;vertical-align: bottom;padding:4px;text-align:left;padding-left:12px">
                            <input type="text" value="{{ $medicaid_spouse_monthly_spend_down }}"
                                style='border:none' class="no-border" name="medicaid_spouse_monthly_spend_down">
                        </td>
                    </tr>
                </table>
                <br>
                <div style="margin: 0;padding: 0;" class='xs'>
                    <span>if the Beneficiary receives other benefits, such as Food Stamps, HUD Section 8, etc. list
                        these
                        benefits.
                        and monthly amounts.
                    </span>
            ...
            <table style=" padding: 0;margin: 0;" class='sm'>
                <thead>
                    <tr style="padding: 0;margin: 0;">
                        <td style="padding:3px ;margin: 0;">
                            <p style="padding: 5px;margin: 0;color:#349f99;text-align:left;padding-left:12px;width:230px"
                                class='xs'> TYPE OF BENEFIT MONTHLY AMOUNT</p>
                        </td>
                        <td style="padding: 5px;margin: 0;">
                            <p style="padding: 3px;margin: 0;text-align:left;padding-left:12px" class='xs'>
                                Applicant <br></p>
                        </td>
                        <td style="padding:5px ;margin: 0;">
                            <p style="padding: 3px;margin: 0;text-align:left;padding-left:12px" class='xs'> Spouse
                                <br>
                            </p>
                        </td>
                    </tr>
                ...
                <tr style="padding: 0;margin: 0;" class='xs'>
                    ...
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="margin: 3px;"><span>$</span> <input style='border:none;vertical-align:sub'
                                type="text" value="{{ $applicant_ssi }}" class="no-border" name="applicant_ssi">
                        </p>
                    </td>
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="margin: 3px;"><span>$</span> <input style='border:none;vertical-align:sub'
                                type="text" value="{{ $spouse_ssi }}" class="no-border" name="spouse_ssi"></p>
                    </td>
                </tr>
                <tr style=" padding: 0;margin: 0 ">
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px">
                    ...
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="margin: 3px;"><span>$</span> <input style='border:none;vertical-align:sub'
                                type="text" value="{{ $applicant_ssdi }}" class="no-border"
                                name="applicant_ssdi">
                        </p>
                    </td>
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="margin: 3px;"><span>$</span> <input style='border:none;vertical-align:sub'
                                type="text" value="{{ $spouse_ssdi }}" class="no-border" name="spouse_ssdi">
                        </p>
                    </td>
                </tr>
                <tr style=" padding: 0;margin: 0 ">
                    ...
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px"
                        class='xs'>
                        <p style="margin: 3px;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $applicant_ssa }}" class="no-border" name="applicant_ssa">
                        </p>
                    </td>
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="margin: 3px;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $spouse_ssa }}" class="no-border" name="spouse_ssa">
                        </p>
                    </td>
                </tr>
                <tr style=" padding: 0;margin: 0 ">
                    <td class='xs'
                        style="width:80px; padding: 0px;text-align:left;padding-left:12px padding: 0px;text-align:left;padding-left:12px">
                        VA Benefits
                    </td>
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $applicant_va_ben }}" class="no-border"
                                name="applicant_va_ben"></p>
                    </td>
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $spouse_va_ben }}" class="no-border" name="spouse_va_ben">
                        </p>
                    </td>
                </tr>
                <tr style=" padding: 4px;margin: 0 " class='xs'>
                    ...
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $applicant_employee_ben }}" class="no-border"
                                name="applicant_employee_ben"></p>
                    </td>
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $spouse_employee_ben }}" class="no-border"
                ...
                <tr style=" padding: 4px;margin: 0 " class='xs'>
                    ...
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $applicant_survivor_ben }}" class="no-border"
                                name="applicant_survivor_ben"></p>
                    </td>
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $spouse_survivor_ben }}" class="no-border"
                ...
                <tr style=" padding: 4px;margin: 0 " class='xs'>
                    ...
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $applicant_ira_dist }}" class="no-border"
                                name="applicant_ira_dist"></p>
                    </td>
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $spouse_ira_dist }}" class="no-border"
                ...
                <tr style=" padding: 4px;margin: 0 " class='xs'>
                    ...
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $applicant_pension_annuities }}" class="no-border"
                                name="applicant_pension_annuities"></p>
                    </td>
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $spouse_pension_annuities }}" class="no-border"
                ...
                <tr style=" padding: 4px;margin: 0 " class='xs'>
                    ...
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $applicant_interest_dividends }}" class="no-border"
                                name="applicant_interest_dividends"></p>
                    </td>
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $spouse_interest_dividends }}" class="no-border"
                ...
                <tr style=" padding: 4px;margin: 0 " class='xs'>
                    ...
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $applicant_reparations }}" class="no-border"
                                name="applicant_reparations"></p>
                    </td>
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $spouse_reparations }}" class="no-border"
                ...
                <tr style=" padding: 4px;margin: 0 " class='xs'>
                    ...
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $applicant_other }}" class="no-border"
                    ...
                    <td class='xs' style="width:80px; padding: 0px;text-align:left;padding-left:12px; "
                        class='xs'>
                        <p style="padding: 4px;margin: 0;"><span>$</span><input style='border:none;vertical-align:sub'
                                type="text" value="{{ $spouse_other }}" class="no-border" name="spouse_other">
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <div class="page-4">
            <div>
                <p class='italic' style="padding: 2%;text-align: center">FOR ANY APPLICABLE ITEMS BELOW, PLEASE ATTACH
                    THE NECESSARY
                    PROOF.</p>
            </div>
            <p class='md section-heading' style="width:26%;background-color:rgb(184 221 219);color:rgb(52 159 153);">
            ...
            <div style="display: table;">
                <div style="display: table-row;">
                    <div style="display: table-cell;">
                        <p class='md section-heading'
                            style="width:43%;background-color:rgb(184 221 219);color:rgb(52 159 153);;font-size: 14px;">
                            FUNERAL INFORMATION</p>
                    </div>
                </div>
                <div style="display: table-row;">
                    <div style="display: table-cell; margin-bottom: 2px;">
                        ...
                        <p class='italic' style='font-size:13px'>If you answered yes, please attach funeral
                            provision documents.</p>
                    </div>
                </div>
            </div>
            <div style="display: table;">
                <div style="display: table-row;">
                    <div style="display: table-cell;">
                        <p class='md section-heading'
                            style="width:32%;background-color:rgb(184 221 219);color:rgb(52 159 153);;font-size: 14px;">
                            LIFE INSURANCE INFORMATION</p>
                    </div>
                </div>
                <p style="padding:0;margin: 0;" class='xs'>
                ...
                <div style="display: table-row;">
                    <div style="display: table-cell;padding-bottom:14px" class='xs'>
                        ...
                        <label>Policy #</label>
                        <input type="text" value="{{ $insurance_policy_number }}"
                ...
                <div style="display: table-row;" class='xs'>
                    <div style="display: table-cell; padding-bottom: 14px;">
                        ...
                        <label>
                            <input style="height: 15px; vertical-align: middle;" type="checkbox"
                                name="type_of_policy1" value="Term"
                                {{ isset($type_of_policy1) && $type_of_policy1 === 'Term' ? 'checked' : '' }}>
                            Term
                        </label>
                        <input type="text" value="{{ $healthcare_plan }}" class="no-border"
                            name="healthcare_plan" style="margin-left: 5px;">

                        <label>
                            <input style="height: 15px; vertical-align: middle;" type="checkbox"
                                name="type_of_policy1" value="Life"
                                {{ isset($type_of_policy1) && $type_of_policy1 === 'Life' ? 'checked' : '' }}>
                            Life
                        </label>
                        <input type="text" value="{{ $healthcare_plan2 }}" class="no-border"
                            name="healthcare_plan2" style="margin-left: 5px;">
                        <br>
                        <span style='padding-top:5px;margin-top:5px'>
                            <label>Cash Surrender Value</label>
                            <input type="text" value="{{ $cash_surrender_value }}"
                                name="cash_surrender_value" style="margin-left: 5px;">
                        </span>
                    </div>
                </div>
            ...
            <span class='md md section-heading'
                ...
                LIVING ARRANGEMENTS </span>
            <p class='italic' style='padding:0' class='xs'> Please attach a copy of the guardianship order
                with this Joinder Agreement.</p>
            <p style="padding:0;margin: 0;" class='xs'>
            ...
            <div style="display: table;width:100%;margin-top:4px">
                <div style="display: table-row;">
                    <div style="display: table-cell;" class='xs'>
                        <input type="text" value="{{ $living_arrangement_first }}"
                            name="living_arrangement_first" style="width: 95%" /> <br>
                        <label>First</label>
                    </div>

                    <div style="display: table-cell" class='xs'>
                        <input type="text" value="{{ $living_arrangement_last }}"
                            name="living_arrangement_last" style="width: 95%" /> <br>
                        <label>Last</label>
                    </div>
                </div>
                <div style="display: table-row;">
                    <div style="display: table-cell;" class='xs'>
                        <input type="text" value="{{ $living_arrangement_primary }}"
                            name="living_arrangement_primary" style="width: 95%" /> <br>
                        <label>Primary Phone</label>
                    </div>
                    &nbsp;
                    <div style="display: table-cell" class='xs'>
                        <input type="text" value="{{ $living_arrangement_email }}"
                            name="living_arrangement_email" style="width: 95%" /> <br>
                        <label>Email</label>
                    </div>
                </div>
            </div>
        ...
        <div class="page-5">
            ...
            <div class="section-title">
                <p class="strong md section-heading"
                    style="width:25%;background-color:rgb(184 221 219);color:rgb(52 159 153);">
                    POWER OF ATTORNEY
                </p>

                <div class="pa-container xs">
                    <p class="strong sm" style="margin:0;margin-bottom:15px">Power of Attornery <span
                            class="italic"> Please attach a copy of Power of Attorney</span></p>

                    <div style="display: table; width: 100%;" class="xs">
                        <div style="display: table-row;margin-bottom:0">
                            <div style="display: table-cell;margin-bottom:0">

                                <input type="text" value="{{ $power_fname }}" name="power_fname"
                                    style="width: 95%;margin-bottom:0" />
                                <label class="italic">First</label>
                            </div>
                            <div style="display: table-cell">
                                <input type="text" value="{{ $power_lname }}" name="power_lname"
                                    style="width: 95%" />
                                <label class="italic">Last</label>
                            </div>
                        </div>
                    ...
                    <div style="display: table; width: 100%; margin-top:6px" class="xs">
                        <div style="display: table-row;">
                            <div style="display: table-cell;margin-top:6px">
                                ...
                                <input type="text" value="{{ $power_tel_home }}" name="power_tel_home"
                                    style="width: 95%" /> <br>
                                <label class="italic">Primary Phone</label>
                            </div>
                            <div style="display: table-cell;margin-top:6px">
                                <input type="text" value="{{ $power_email }}" name="power_email"
                                    style="width: 95%" /> <br>
                                <label class="italic">Email</label>
                            </div>
                        </div>
                    ...
                    <div style="display: table;width:100%;margin-top:6px">
                        <div style="display: table-row;" class="xs">
                            <div style="display: table-cell;margin-top:6px">
                                <input type="text" value="{{ $power_address }}" name="power_address"
                                    style="width: 95%">
                                <label class="italic">Address</label>
                            </div>
                            <div style="display: table-cell;margin-top:6px">
                                <input type="text" value="{{ $power_apt }}" name="power_apt"
                                    style="width: 95%">
                                <label class="italic">Apt #</label>
                            </div>
                            <div style="display: table-cell;margin-top:6px">
                                <input type="text" value="{{ $power_city }}" name="power_city"
                                    style="width: 95%" />
                                <label class="italic">City</label>
                            </div>
                            <div style="display: table-cell;margin-top:6px">

                                <input type="text" value="{{ $power_state }}" name="power_state"
                                    style="width: 95%" />
                                <label class="italic">State</label>
                            </div>
                            <div style="display: table-cell;margin-top:6px">
                                <input type="text" value="{{ $power_zip }}"name="power_zip"
                                    style="width: 95%" />
                                <label class="italic">Zip</label>
                            </div>
                        </div>
                    ...
                    <p style="margin: 0;margin-top:15px">Is this person the sole POA? <input type="checkbox"
                            name="sole_poa1" value="Yes"
                            {{ isset($sole_poa1) && $sole_poa1 === 'Yes' ? 'checked' : '' }}>
                        <label>Yes</label>
                    ...
                    <p style="margin: 0;margin-top:6px">
                        If No, are the agents authorized to act separately? <input type="checkbox"
                            name="act_seprately1" value="Yes"
                            {{ isset($act_seprately1) && $act_seprately1 === 'Yes' ? 'checked' : '' }}>
                        <label>Yes</label>
                ...
                <div style="margin-top: 5px" class="pa-container xs">
                    ...
                    <p style="margin:0;margin-bottom:15px" class="strong sm">Power of Attornery - Second Agent <span
                            class="italic"> Please attach a copy of Power of Attorney</span></p>
                    <div style="display: table; width: 100%;">
                        ...
                        <div style="display: table-row;">
                            <div style="display: table-cell;">
                                ...
                                <input type="text" value="{{ $power_fname2 }}" name="power_fname2"
                                    style="width: 95%" /> <br>
                                <label class="italic">First</label>
                            </div>
                            <div style="display: table-cell">
                                <input type="text" value="{{ $power_lname2 }}" name="power_lname2"
                                    style="width: 95%" /> <br>
                                <label class="italic">Last</label>
                            </div>
                        </div>
                    ...
                    <div style="display: table; width: 100%;margin-top:6px">
                        ...
                        <div style="display: table-row;">
                            <div style="display: table-cell;margin-top:6px">
                                ...
                                <input type="text" value="{{ $power_tel_home2 }}" name="power_tel_home2"
                                    style="width: 95%" /> <br>
                                <label class="italic">Primary Phone</label>
                            </div>

                            <div style="display: table-cell;margin-top:6px">
                                <input type="text" value="{{ $power_email2 }}" name="power_email2"
                                    style="width: 95%" /> <br>
                                <label class="italic">Email</label>
                            </div>
                        </div>
                    ...
                    <div style="display: table;width:100%;margin-top:6px">
                        <div style="display: table-row;" class="xs">
                            <div style="display: table-cell;margin-top:6px">
                                <input type="text" value="{{ $power_address2 }}" name="power_address2"
                                    style="width: 95%">
                                <label class="italic">Address</label>
                            </div>
                            <div style="display: table-cell;margin-top:6px">
                                <input type="text" value="{{ $power_apt2 }}" name="power_apt2"
                                    style="width: 95%">
                                <label class="italic">Apt #</label>
                            </div>
                            <div style="display: table-cell;margin-top:6px">
                                <input type="text" value="{{ $power_city2 }}" name="power_city2"
                                    style="width: 95%" />
                                <label class="italic">City</label>
                            </div>
                            <div style="display: table-cell;margin-top:6px">

                                <input type="text" value="{{ $power_state2 }}" name="power_state2"
                                    style="width: 95%" />
                                <label class="italic">State</label>
                            </div>
                            <div style="display: table-cell;margin-top:6px">
                                <input type="text" value="{{ $power_zip2 }}"name="power_zip2"
                                    style="width: 95%" />
                                <label class="italic">Zip</label>
                            </div>
                        </div>
                    ...
                    <p style="margin: 0;margin-top:15px">Is this person the sole POA? <input type="checkbox"
                        ...
                        <input type="checkbox" name="power_of_attorney2_yes" value="No"
                            {{ isset($power_of_attorney2_yes) && $power_of_attorney2_yes === 'No' ? 'checked' : '' }}>
                        No
                    </p>
                    <p style="margin: 0;margin-top:6px">
                        If No, are the agents authorized to act separately? <input type="checkbox"
        ...
        No
                ...
                <p class="md strong section-heading"
                    style=";width:27%;background-color:rgb(184 221 219);color:rgb(52 159 153);">
        ...
        <input type="checkbox" name="guardian_information_yes" value="No"
            {{ isset($guardian_information_yes) && $guardian_information_yes === 'No' ? 'checked' : '' }}> No
                ...
                <div style="display: table; width:100%" class="xs">
                    <div style="display: table-row;">
                        <div style="display: table-cell;">
                            ...
                            <input type="text" value="{{ $guardianship_fname }}" name="guardianship_fname"
                                style="width: 95%" /> <br>
                            <label class="italic">First</label>
                        </div>
                        &nbsp;
                        <div style="display: table-cell">
                            <input type="text" value="{{ $guardianship_lname }}" name="guardianship_lname"
                                style="width: 95%" /> <br>
                            <label class="italic">Last</label>
                        </div>
                    </div>
                    <div style="display: table-row;">
                        <div style="display: table-cell;">
                            ...
                            <input type="text" value="{{ $guardianship_telephone }}"
                                name="guardianship_telephone" style="width: 95%" /> <br>
                            <label class="italic">Primary Phone</label>
                        </div>
                        &nbsp;
                        <div style="display: table-cell">
                            <input type="text" value="{{ $guardianship_email }}" name="guardianship_email"
                                style="width: 95%" /> <br>
                            <label class="italic">Email</label>
                        </div>
                    </div>
                ...
                <div style="display: table; padding: 0; margin: 0;width: 100%">
                    <div style="display: table-row;">
                        <p class="sm"
                            style="display: table-cell; vertical-align: top; padding-right: 20px;float:left;">
                            Service
                            <input type="text" value="{{ $beneficiary_service_one }}" class="no-border xs"
                                name="beneficiary_service_one"><br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
                                type="text" value="{{ $beneficiary_service_two }}" class="no-border xs"
                                name="beneficiary_service_two" style="margin-top: 8px"><br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
                                type="text" value="{{ $beneficiary_service_three }}" class="no-border"
                                name="beneficiary_service_three" style="margin-top: 8px" class="xs">
                        </p>
                        <p class="md"
                            style="display: table-cell; vertical-align: top; text-align: left;float:right;">
                            Name of Provider
        ...
        <div class="page-6 sm" style="position: relative;">
            <p style="background-color:rgb(184 221 219); color:rgb(52 159 153); width:33%"
                class="strong md section-heading">
                INFORMATION AND DISCLOSURES:
            </p>
            <div class="column-left"
                style="float: left; width: 49%; padding-right: 1%; box-sizing: border-box;text-align:justify;line-height:1.1">
                <div class="strong" style="margin-bottom: 0;">Death of Beneficiary:</div>
                <p style="margin-top: 0; padding-top: 0;">The Beneficiary’s sub-trust account terminates
                ...
                of the SLC Supplemental Needs Trust which are incorporated by reference herein.<br /> The Trustees shall
                have the sole and absolute right to accept or refuse additional deposits to the subtrust account.<br />
            ...
            <div class="column-right"
                style="float: left; width: 49%; padding-left: 1%; box-sizing: border-box;text-align:justify;line-height:1.1;margin-top:0px">
                account.
                <br />
                <br />
                <div class="strong" style="margin-bottom: 0;">Disbursements: </div>
                <p style="margin-top: 0; padding-top: 0;">All disbursement requests shall be reviewed and
                    ...
                    items relating to illegal activity, bail, or restitution. <br /> All disbursements shall be made at
                    the sole and
        ...
        <div class="page-break"></div>
        <div class="page-8">
            <p class='section-heading md'
                style="width:26%;background-color:rgb(184 221 219);color:rgb(52 159 153);">AGREEMENT SIGNATURE</p>
            <p class='xs' style="padding:0;margin: 0;padding-bottom:2px">
                ...
                <input type="checkbox" name="agreement_signature_beneficiary" value="Beneficiary"
                    {{ isset($agreement_signature_beneficiary) && $agreement_signature_beneficiary === 'Beneficiary' ? 'checked' : '' }}>
                Beneficiary
            ...
            <p class='xs' style='margin:0;padding-bottom:12px'>I certify that the above information is accurate
                and the completed to the best of my knowledge.</p>
                        ...
                        <div class='xs'>
                            @if ($joinder_signature_1)
                                <img src="{{ $joinder_signature_1 }}" alt="Signature 1" width="300px"
                                    height="70px" style="display: block; border-bottom: 1px solid;width:80%">
                            @else
            ...
            <br>
            <p class='section-heading md'
                style="width:25%;background-color:rgb(184 221 219);color:rgb(52 159 153);;margin:0:padding-bottom:2px">
            ...
            <div style='display:table;width:100%'>
                ...
                <div style='display:table-row' class='xs'>
                    <p style="margin:0;padding-bottom:5px;display:table-cell">
                        ...
                        <input type="text" value="{{ $notary_year }}" class="no-border"
                            name="notary_year">
                    </p>
                </div>
                <div style='display:table-row' class='xs'>
                    <div style='display:table-cell;width:50%'>
                        <p style="margin:0;padding-bottom:5px:">
                            ...
                            <input type="text" value="{{ $notary_appeared }}" class="no-border"
                                name="notary_appeared">
                            <br> personally known to me or proved to me on the basis of satisfactory evidence to be the
                            individual whose
                            name
                    ...
                    <div style='display:table-cell;vertical-align:bottom;width:50%'>
                        <input type="text" value="{{ $notary_public }}" style='width:90%;margin-left:30px'
                            class="no-border" name="notary_public"><br>
            ...
            <p class='md section-heading'
                style=" width:37%;background-color:rgb(184 221 219);color:rgb(52 159 153);">OR SIGNATURE OF TWO
                WITNESSES</p>
            <p class='xs'>
        ...
        <div class="page-9">
                ...
                <div style="display: table-row;border: none;">
                    <table class="mem-table" style="border: none;">
                        <tr style="border:none;padding: 5px;background-color:rgb(184 221 219)">
                            <td class="md strong" colspan="2" style="color: rgb(52 159 153);border: none;">FOR
                                OFFICE USE ONLY</td>
                        </tr>
                    </table>
                    <div
                        style="display: table; width:100%;background-color: #ecf6f7;text-align:center;padding:15px 0px">
                        {{-- <br> --}}
                        <div style="display: table-row;margin-top:10px" class="md">
                            <div style="display: table-cell;">

                                <label class="sm">Member ID#:</label>
                                <input style="background-color: #ecf6f7" class="xs" type="text"
                                    value="{{ $office_use_member_id_above }}" name="office_use_member_id_above" />
                            </div>
                        </div>
                        <br>
                        <div style="display: table-row;" class="md">
                            <div style="display: table-cell;">
                                ...
                                <input style="background-color: #ecf6f7" class="xs" type="text"
                                    value="{{ $office_use_effective_date }}" name="office_use_effective_date" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <p class="strong md"
                style="background-color:rgb(184 221 219); color:rgb(52 159 153);width:32%;padding:8px 20px">DIRECT
                DEBIT REQUEST FORM</p>
            ...
            <div style="display: table; width: 100%;" class="xs">
                <div style="display: table-row;" class="md">
                    <div style="display: table-cell;">
                        ...
                        <input class="xs" type="text" value="{{ $direct_debit_donor_beneficiary }}"
                            name="direct_debit_donor_beneficiary" style="width: 80%" />
                    </div>
            ...
            <div style="display: table; width: 100%;margin-top:10px" class="xs">
                <div style="display: table-row;" class="md">
                    <div style="display: table-cell;margin-top:10px">
                        ...
                        <input class="xs" type="text" value="{{ $direct_debit_representative }}"
                            name="direct_debit_representative" style="width: 82%" />
                    </div>
                </div>
            ...
            <div style="display: table; width: 100%; margin-top:10px" class="xs">
                <div style="display: table-row;" class="md">
                    <div style="display: table-cell;margin-top:10px">
                        ...
                        <input class="xs" type="text" value="{{ $direct_debit_bank_name }}"
                            name="direct_debit_bank_name" style="width: 60%" />
                    </div>
                    <div style="display: table-cell;margin-top:10px">

                        <label class="sm">City</label> &nbsp;
                        <input class="xs" type="text" value="{{ $direct_debit_city }}"
                            name="direct_debit_city" style="width: 70%" />
                    </div>
                    <div style="display: table-cell;margin-top:10px">

                        <label class="sm">State</label> &nbsp;
                        <input class="xs" type="text" value="{{ $direct_debit_state }}"
                            name="direct_debit_state" style="width: 72%" />
                    </div>
            ...
            <div style="display: table; width: 100%; margin-top:10px" class="xs">
                <div style="display: table-row;" class="md">
                    <div style="display: table-cell;margin-top:10px">
                        ...
                        <input class="xs" type="text" value="{{ $direct_debit_bank_routing }}"
                            name="direct_debit_bank_routing" style="width: 50%" />
                    </div>
                    <div style="display: table-cell;margin-top:10px">

                        <label class="sm">Account Number</label> &nbsp;
                        <input class="xs" type="text" value="{{ $direct_debit_account_number }}"
                            name="direct_debit_account_number" style="width: 56%" />
                    </div>
            ...
            <div style="display: table; width: 100%; margin-top:10px" class="xs">
                <div style="display: table-row;" class="md">
                    <div style="display: table-cell;width:60%;margin-top:10px">
                        ...
                        <input class="xs" type="text" value="{{ $direct_debit_account_name }}"
                            name="direct_debit_account_name" style="width:70%" />
                    </div>
                    {{-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --}}
                    <div class="sm"
                        style="display: table-cell;vertical-align:middle;text-align:right;margin-top:10px">
                        <label class="sm">Account Type: </label>
                        <input type="checkbox" name="direct_debit_bank_type1" value="Checking"
                            {{ isset($direct_debit_bank_type1) && $direct_debit_bank_type1 === 'Checking' ? 'checked' : '' }}>Checking
                        <input type="checkbox" name="direct_debit_bank_type1" value="Savings"
                            {{ isset($direct_debit_bank_type1) && $direct_debit_bank_type1 === 'Savings' ? 'checked' : '' }}>Savings
                    </div>
                    ...
                    <div style="display: table;width:100%">
                        <div style="display: table-row;width:100%">
                            <div style="display: table-cell;">
                                ...
                                <input class="xs" type="text" value="{{ $office_use_account_number }}"
                                    name="office_use_account_number" />
                            </div>
                            &nbsp;&nbsp;
                            <div style="display: table-cell;">
                                <label class="sm">MemberID #:</label>
                                <input class="xs" type="text" value="{{ $office_use_member_id_below }}"
                    ...
                    <div style="display: table;margin-top:10px;width:100%">
                        <div style="display: table-row;">
                            <div style="display: table-cell;width:50%">
                                ...
                                <input class="xs" type="text" value="{{ $office_use_processed_by }}"
                                    name="office_use_processed_by" style="width:55%" />
                            </div>
                            {{-- &nbsp;&nbsp; --}}
                            ...
                            <div style="display: table-cell;width:40%">
                                ...
                                <input class="xs" type="text"
                                    ...
                                    name="office_use_monthly_debit_amount" style="width:35%" />
                            </div>
                        </div>
                    </div>
                    {{-- <br> --}}
                    <div style="display: table;">
                        <div style="display: table-row;">
                            <div style="display: table-cell;text-align: start; !important">
                                <p class="sm">
                                    Monthly dates for direct debit are as follows: 1, 3, 7, 14, 21, 28 (debit will occur
                                    on or around the date selected)
                                </p>
                            </div>
                        </div>
                    </div>
