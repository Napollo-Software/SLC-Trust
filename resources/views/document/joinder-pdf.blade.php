    ...
    <form id="joinderForm" method="POST" action="{{ route('save.joinder') }}">
        ...
        <div class="page-0">
            ...
            <div class="740px">
                ...
                <div
                    style="width: 100%; text-align: center; white-space: nowrap; display: table; border-collapse: collapse; margin-top: 100px">
        ...
        <div class="page-1">
            <div class="center-text" style="background-color: rgb(184 221 219);padding-top: 7px;padding-bottom: 7px;padding-left:10px;padding-right:10px;">
                <p style="font-weight: bold;text-align:center; margin-bottom: 10px;  padding-bottom: 0px; line-height: 1;" class="lg">SLC SUPPLEMENTAL NEEDS TRUST</p>
                <p style="text-align:center;color:rgb(52 159 153); line-height: 1; margin-top: 0px; padding-top: 0;" class="lg">Joinder Agreement / Beneficiary
                    Profile Sheet</p>
            </div>
            <div style="" class="xs">
                <p style="letter-spacing: 0px;">This is a legal document. It is an agreement pertaining to a supplemental needs trust created
