        ...
        <div>
            ...
            <div class="content">
                ...
                <div style="position: relative;left: 40%;margin-top:35px">
                    ...
                    @if($user->created_at)
                    <p style="margin:0;margin-top:2px;font-size:14px;font-family:Poppins-Bold;line-height: 0.8;text-decoration: underline;">Date Established: <span style="font-size:14px;font-family: Poppins-Regular;text-decoration: underline;">{{ date('m/d/Y',strtotime($user->formatted_created_at)) }}</span></p>
                    @endif
                </div>
