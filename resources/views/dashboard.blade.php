...
@section('wrapper')
    ...
    @if ($role != 'User')
        ...
        <div class="modal fade" id="update-bill-status" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                ...
                <div class="col-lg-12 mb-12">
                    <div class="card d-flex">
                                ...
                                <form id="search_bills" action="<?= url('search-bills') ?>" method="POST">
                                    <div class="d-flex custom-float">
                                        ...
                                        <div class="input-group-append">
                                            <button type="submit"
                                                class="input-group-text btn btn-primary ml-2 cursor-pointer search p-1 m-1"
                                                id="basic-addon2"><i class="bx bx-search fs-4 lh-0 pl-1"></i></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="card-body pt-1" style="margin-top: -35px">
                            ...
                            <a class="btn btn-primary print-btn d-none" href="{{ route('printpage') }}"
                                target="blank">Export<i class='bx bx-printer'></i></a>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="claims/{{ $claim['id'] }}"><i
                                                                    class="bx bx-menu me-1"></i>Status</a>
                                                            @if ($role != 'User')
                                                                <a class="dropdown-item"
                                                                    href="edit-bill/{{ $claim['id'] }}"><i
                                                                        class="bx bx-edit-alt me-1"></i> Edit</a>
                                                            @endif
                                                            @if ($role != 'User')
                                                                <form
                                                                    action="{{ action('App\Http\Controllers\claimsController@destroy', $claim['id']) }} "
                                                                    id="delete_bill" method="post">
                                                                    @csrf
                                                                    @method('delete')
