...
<div class="">
    ...
    <form method="post" id="leadStoreForm" novalidate action="{{ route('store.lead') }}">
        @csrf
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 p-2">
                        ...
                        <input type="text" class="form-control phone" placeholder="(___) ___-___" name="contact_phone" value="{{ old('patient_phone') }}" id="contact_phone" required />
                    </div>
                    <div class="col-md-6 p-2">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 p-2">
                        <label for="form-label">Patient First Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="patient_first_name" name="patient_first_name" required>
                    </div>
                    <div class="col-md-6 p-2">
                        <label for="form-label">Patient Last Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="patient_last_name" name="patient_last_name" required>
                    </div>
                    <div class="col-md-6 p-2">
                        <label for="form-label">Patient Phone <span class="text-danger">*</span></label>
                        <input type="text" class="form-control phone" placeholder="(___) ___-___" name="patient_phone" value="{{ old('patient_phone') }}" id="patient_phone" required />
                    </div>
                    <div class="col-md-6 p-2">
                        <label for="form-label">Patient Email <span class="text-danger">*</span></label>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 p-2">
                        <label for="form-label">Sub-Status <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="row">
                        ...
                        <div class="col-md-6 p-2" id="contact_id">
                            <label for="form-label"> Contact <span class="text-danger">*</span></label>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 p-2">
                        <label for="form-label">Assign To <span class="text-danger">*</span></label>
        ...
        <div class="card mb-3 d-none">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 p-2">
                        <label for="form-label">Follow-Up Date <span class="text-danger">*</span></label>
                        <input type="date" class="form-control" name="follow_up_date">
                    </div>
                    <div class="col-md-6 p-2">
                        <label for="form-label">Follow-Up Time <span class="text-danger">*</span></label>
                        <input type="time" class="form-control" name="follow_up_time">
                    </div>
                    <div class="col-md-12 p-2">
                        <label for="form-label">Follow-Up Note <span class="text-danger">*</span></label>
        ...
        <div class="row">
            <div class="col-md-5">
                <button class="btn btn-primary submit-btn" data-value="0"><i class="menu-icon tf-icons bx bx-save"></i>Save</button>
                <button class="btn btn-info text-white" data-value="1"><i class="menu-icon tf-icons bx bx-shekel"></i>Convert
                    to referral</button>
                <a class="btn btn-secondary" href="{{ route('lead.list') }}"><i class="menu-icon tf-icons bx bx-trash"></i>Cancel</a>
            </div>
        </div>
    </form>
</div>
