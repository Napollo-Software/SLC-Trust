                ...
                <div class="table-row">
                    <div class="table-cell" style="width:30%;">
                        <div class="my-company">
                            <b>SLC Supplemental Needs Trust</b>
                        </div>
                    </div>

                    <div class="table-cell" style="width:40%; text-align:center;">
                        <div style="text-transform: uppercase; font-weight: bold; font-size: 16px;">
                            {{ $formData['bankName'] ?? '' }}
                        </div>
                    </div>
            ...
            <div class="table-layout">
                <div class="table-row">
                    ...
                    <div class="table-cell w-50 text-end">
                        <span class="font-helvetica" style="font-weight: bold;">Date:</span>
                        <span class="my-date" style="padding-bottom: 2px;">{{ $formData['checkDate'] ?? '' }}</span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-layout">
                            <div class="table-row">
                                ...
                                <div class="table-cell" style="width: 90%;">
                                    <div class="font-helvetica my-orderof" style="padding-right: 2px;">
                                        {{ $formData['user'] ?? '' }}
                                    </div>
                                </div>
                            </div>
                ...
                <div class="table-row">
                   <div class="table-cell font-helvetica" style="width:70%; border-bottom:0.5px solid #000;">
                    ...
                    <div class="table-cell font-helvetica"
                        style="width: 20%; vertical-align: bottom;padding-left:5%; font-weight: bold;">Dollars</div>
                </div>
            </div>
                ...
                <div class="table-row">
                    <div class="table-cell" style="width: 30%;">
                        <div class="table-layout">
                            <div class="table-row">
                                <div class="table-cell"
                                    style="width: 5%; vertical-align: middle; font-size: 10px; font-weight:bold">
...
">
        ...
        <div
            style="width:100%; height:100vh; display:table; border-collapse:collapse; font-family:'Times New Roman', Times, serif; padding:50px; margin-top:25px; background:#fff;">

            <div class="table-row" style="padding:10px 0px; line-height:1.6">

                <div style="display:table-cell; padding:6px 2px; text-align:left; vertical-align:middle;">
                    {{ $formData['checkNumber'] ?? '' }}
                </div>

                <div style="display:table-cell; padding:6px 2px; text-align:center; vertical-align:middle; width:33%;">
                    Amount:$ {{ $formData['amountInNumber'] ?? '' }}
                </div>

                <div style="display:table-cell; padding:6px 2px; text-align:right; vertical-align:middle;">
  ...
  <div class="table-layout" style="width: 100%; ">
            ...
            <div class="table-layout" style="margin-top:40px">
                ...
                <div class="table-row row-gap" style="padding:10px 0px; line-height:1.6">
                    <div style="display:table-cell; vertical-align:middle; white-space:normal; word-wrap:break-word;">
