    ...
    <div class="row d-flex justify-content-center">
        <div class="check print-check">
            ...
            <div class="memo memo-text"><small>Aleksandra Gelman-Apt 9F, 2775 West 5ht streat(3B) Brooklyn, NY
                    11224</small></div>
            <div class="sig signature">{{ config('app.name') }}
            </div>
        </div>
    </div>
</div>
...
<div id="checkContent" class="printable d-none">
    ...
    <p style="padding-left: 12%"><span class="payee-text">Usama Fiaz</span><span style="padding-left: 70%"><span class="amount-in-number-text">$566</span></span></p>
