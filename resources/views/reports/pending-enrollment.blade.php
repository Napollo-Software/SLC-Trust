...
@section('wrapper')
    ...
    <div class="">
        <h5 class=" d-flex justify-content-start pt-3 pb-2">
            <b></b>
            <div> <a href="{{ url('/main') }}" class="text-muted fw-light pointer"><b>Dashboard</b></a> / <b>Pending
                    Enrollment Reports</b> </div>
        </h5>
                        ...
                        <div class="card-body ">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="radio" id="status_pending" name="status"
                                    value="pending" Checked @if (old('status') == 'pending') checked @endif>
    ...
    $(document).on('click', '#exportBtn', function(e) {
        ...
        $.ajax({
            ...
            success: function(response, status, xhr) {
                ...
                link.download = "PendingEnrollments_" + new Date().toISOString().slice(0, 19)
                    .replace(/[:T]/g, "_") + ".xlsx";
