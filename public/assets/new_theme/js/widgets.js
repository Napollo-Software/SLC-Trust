$(function () {
	...
	var options = {
		series: [{
			name: 'Total Income',
			data: [240, 160, 671, 414, 555, 257, 901, 613, 727, 414, 555, 1000]
		}],
		chart: {
			type: 'area',
			height: 65,
	...
	var options = {
		series: [{
			name: 'Total Users',
			data: [240, 160, 500, 600, 555, 257, 901, 613, 727, 800, 600, 1000]
		}],
		chart: {
			type: 'area',
			height: 65,
	...
	var options = {
		series: [{
			name: 'Comments',
			data: [100, 200, 300, 414, 555, 257, 600, 450, 727, 414, 555, 800]
		}],
		chart: {
			type: 'area',
			height: 65,
